...
#define STRING_CONFIG_H_AUTHOR "Daniel Stotts for my Ender3 v2 4.2.2" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 157.28
  #define DEFAULT_bedKi 30.25
  #define DEFAULT_bedKd 545.23
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44.8, -5.2, -2.92 }
